<div class="main-content">
    <section class="section">
        ...
        <a href="<?php echo base_url('admin/data_customer/tambah_customer') ?>" class="btn btn-primary mb-4 color-white" >Tambah Data</a>
